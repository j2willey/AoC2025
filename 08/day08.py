...
def get_all_distances_for_neighbor_pairs(points):
...
def day8Part1(filename = "input.txt"):
    ...
    distances = get_all_distances_for_neighbor_pairs(points)
    ...
    return product_of_top3, "product of top 3 circuit sizes"
